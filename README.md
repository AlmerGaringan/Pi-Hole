...
The hardware I used for this project was a Raspberry Pi 4, a travel router, and a wireless Ethernet adapter. 

The OS I used for this was Raspberry Pi OS and Ubuntu Server
...
Curl is used to fetch or retrieve the data in that URL or from the server, and then -sSL: -s means silent mode, -S only shows errors, but this only works with -s, and L means any redirection 
